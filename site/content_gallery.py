...
{figs}
    ...
    body_html = f'''
<div class="wrap">
  <p class="lede">{real} job photos from the licensed provider Groveland Concrete routes requests to, plus a few concept renderings (labelled) that show a finish before it is built. Projects are across Central Florida; the same crews, materials and specs serve Groveland, Mascotte, Minneola, Clermont, Montverde, Howey-in-the-Hills and rural Lake County.</p>
...
<section>
  <div class="wrap" style="text-align:center">
    ...
    <p class="lede" style="margin:0 auto 20px">Tell us about your driveway, pool deck, patio or walkway and we will route it to the provider who covers your area.</p>
...
'''
    return [{
        ...
        "meta_description": "Job photos from the provider serving Groveland and South Lake County: paver driveways, marble and travertine pool decks, raised paver terraces, entry steps and walkways.",
        "h1": "Photo Gallery",
